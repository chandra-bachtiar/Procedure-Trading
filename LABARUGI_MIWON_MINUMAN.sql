CREATE PROCEDURE LABARUGI_MIWON_MINUMAN(
  BULAN SMALLINT,
  TAHUN BIGINT)
RETURNS(
...
BEGIN
  ...
  AND (D.KODE_GROUPBARANG = 'MINUMAN' OR D.KODE_GROUPBARANG = 'MINUMAN UTAMA')
  ...
  -- OPRASIONAL
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'601-002',0) INTO :OP_GAJI; 
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'615-02',0) INTO :OP_TUNJANGAN_LEBARAN;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'617.003',0) INTO :OP_INSENTIF_BONUS; 
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'616-02',0) INTO :OP_TUNJANGAN_SERANGAM; 
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'620-02',0) INTO :OP_PROMOSI; 
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'621-02',0) INTO :OP_LISTRIK;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'622-02',0) INTO :OP_TELEPON; 
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'623-02',0) INTO :OP_PDAM;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'624-02',0) INTO :OP_INTERNET;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'625-005.02',1) INTO :OP_BENSIN;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'626-02',0) INTO :OP_CETAKAN;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'627-02',0) INTO :OP_ATK;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'628-02',0) INTO :OP_ALAT_TOKO;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'629-02',0) INTO :OP_ALAT_GUDANG;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'631-02',0) INTO :OP_LENGKAP_TOKO;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'630-02',0) INTO :OP_LENGKAP_KANTOR;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'632-02',0) INTO :OP_LENGKAP_GUDANG;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'633-02',0) INTO :OP_MATERAI;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'634-002',0) INTO :OP_FOTOCOPY;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'635-02',0) INTO :OP_PARKIR;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'636-02',0) INTO :OP_ANTAR_DOKUMEN;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'637-02',0) INTO :OP_POS;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'638-02',0) INTO :OP_BIAYA_PERIJINAN;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'639-02',0) INTO :OP_BIAYA_STNK;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'640-02',0) INTO :OP_BIAYA_NOTARIS;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'650-02',0) INTO :OP_AKOMODASI;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'651-02',0) INTO :OP_MAKANAN;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'652-02',0) INTO :OP_PRODUKSI;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'653-02',0) INTO :OP_BONGKAR_MUAT;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'654-02',0) INTO :OP_KIRIM_BARANG;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'655-02',0) INTO :OP_PERJALANAN_DINAS;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'656-02',0) INTO :OP_ENTERTAIMENT;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'673-02',0) INTO :OP_KENDARAAN;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'674-02',0) INTO :OP_GEDUNG;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'675-02',0) INTO :OP_ADM_BANK;
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'182-02',0) INTO :OP_SEWA_GEDUNG;
  ...
  SELECT JUMLAH FROM GET_JUMLAHSALDO(:BULAN,:TAHUN,'604.022',0) INTO :OP_KASBON;
